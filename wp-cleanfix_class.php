...
class WPCLEANFIX_CLASS {
	 ...
	 * @var string
	 */
	var $version = kWPCleanFixVersion;
	 ...
	 * @var string
	 */
	var $plugin_name = kWPCleanFixPluginName;
	 ...
	 * @var string
	 */
	var $plugin_slug = kWPCleanFixSlugName;
	 ...
	 * @var string
	 */
	var $options_key = kWPCleanFixSlugName;
	 ...
	 * @var string
	 */
	var $options_title = kWPCleanFixOptionTitle;
